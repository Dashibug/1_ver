...
<div class="container">
    <div class="heading">
        <h1 class="title"><a>Английский крокодил</a></h1>
        ...
        {#if helpIsAsked}
            <Help on:close="{() => helpIsAsked = false}" >
                ...
                <div slot="rules" class="rules" style="color:black">
                    <b>Суть игры</b> - объяснить слово с экрана без слов.<br />
                    <b>Правила игры: </b> <br />
                    1. Игрок показывает слово, используя только мимику, жесты, движения.
                    Ему запрещается произносить слова  и звуки, особенно те,
                    по которым легко угадать слово.<br />
                    2. Запрещается губами проговаривать слова.<br />
                    3. Запрещается показывать загаданное слово по буквам.<br />
                    4. Отгадывающие могут: задавать игроку любые вопросы; просить игрока показать синонимы;
                    перечислять любые появляющиеся варианты. Помните, что очень многое зависит от активности
                    тех, кто отгадывает, от их умения задавать наиболее существенные вопросы.<br />
...
<style>
    ...
    .restart-button:hover, .help-button:hover, .NewWord:hover, .Bad:hover, .Good:hover{
        box-shadow: #000000 0 0 40px;
    }
    .restart-button:focus, .help-button:focus, .NewWord:focus, .Bad:focus, .Good:focus{
        box-shadow: #000000 0 0 40px;
    }
    ...
    @media screen and (max-width: 3900px) {
        ...
        :global(body) {
            ...
            height: auto;
            color: white;
            background: linear-gradient(to top left, #ff69b4 20%, #ffd700 100%);
            font-family: "Comic Sans MS", cursive, sans-serif;
            font-size: 18px;   
        }

        .restart-button, .help-button, .NewWord, .Bad, .Good
        {
            background: linear-gradient(135deg, #FF00FF 0%, #00FFFF 100%); /* Градиентный фон */
            color: #00FFFF; /* Красный цвет текста */
            border: 5px solid #FFFF00; /* Желтая граница */
            border-radius: 50px;
            font-size: 100px;
